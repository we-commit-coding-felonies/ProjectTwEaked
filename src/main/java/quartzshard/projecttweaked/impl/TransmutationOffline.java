        ...
        if (playerData.exists())
        {
            ...
            if (player.exists() && player.isFile()) {
                try(FileInputStream in = new FileInputStream(player)) {
                    ...
                    IKnowledgeProvider provider = ProjectTwEakedAPI.KNOWLEDGE_CAPABILITY.getDefaultInstance();
                    ProjectTwEakedAPI.KNOWLEDGE_CAPABILITY.readNBT(provider, null, knowledgeProvider);
