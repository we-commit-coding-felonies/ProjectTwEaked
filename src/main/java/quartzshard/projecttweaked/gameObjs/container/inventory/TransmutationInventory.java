...
public class TransmutationInventory extends CombinedInvWrapper
{
	...
	{
		super((IItemHandlerModifiable) player.getCapability(ProjectTwEakedAPI.KNOWLEDGE_CAPABILITY, null).getInputAndLocks(),
				new ItemStackHandler(2), new ItemStackHandler(16));

		this.player = player;
		this.provider = player.getCapability(ProjectTwEakedAPI.KNOWLEDGE_CAPABILITY, null);
