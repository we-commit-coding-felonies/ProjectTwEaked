...
public final class ProjectEAPI
{
	...
	public static IEMCProxy getEMCProxy()
	{
		if (emcProxy == null)
		{
			...
			{
				PECore.LOGGER.warn("[ProjectEAPI] Error retrieving EMCProxyImpl, ProjectTwEaked may be absent, damaged, or outdated.");
			}
		}
		return emcProxy;
	}
	...
	public static IConversionProxy getConversionProxy()
	{
		if (recipeProxy == null)
		{
			...
			{
				PECore.LOGGER.warn("[ProjectEAPI] Error retrieving ConversionProxyImpl, ProjectTwEaked may be absent, damaged, or outdated.");
			}
		}
		return recipeProxy;
	}
	...
	public static ITransmutationProxy getTransmutationProxy()
	{
		if (transProxy == null)
		{
			...
			{
				PECore.LOGGER.warn("[ProjectEAPI] Error retrieving TransmutationProxyImpl, ProjectTwEaked may be absent, damaged, or outdated.");
			}
		}
		return transProxy;
	}
	...
	public static IBlacklistProxy getBlacklistProxy()
	{
		if (blacklistProxy == null)
		{
			...
			{
				PECore.LOGGER.warn("[ProjectEAPI] Error retrieving BlacklistProxyImpl, ProjectTwEaked may be absent, damaged, or outdated.");
			}
		}
