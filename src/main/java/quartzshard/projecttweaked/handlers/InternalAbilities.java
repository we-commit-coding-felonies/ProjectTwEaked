...
public final class InternalAbilities
{
	...
	public void resetProjectileCooldown() {
		projectileCooldown = ProjectTwEakedConfig.misc.projectileCooldown;
	}
	...
	public void resetGemCooldown() {
		gemChestCooldown = ProjectTwEakedConfig.misc.gemChestCooldown;
	}
	...
	// Checks if the server state of player capas mismatches with what ProjectTwEaked determines. If so, change it serverside and send a packet to client
	public void tick()
	{
