...
public final class ProjectEConfig 
{
	...
	public static class PowerFlowerValues {
		@Config.Comment("Set to false to make collectors only use sunlight (meaning they can't be active by just putting glowstone on top)")
		public boolean collectorsRequireSun = false;
