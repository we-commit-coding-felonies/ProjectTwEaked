...
public class Zero extends ItemPE implements IModeChanger, IBauble, IPedestalItem, IItemCharge
{
	...
	{
		if (!world.isRemote && ProjectTwEakedConfig.pedestalCooldown.zeroPedCooldown != -1)
		{
			...
			if (tile.getActivityCooldown() == 0) {
				...
				tile.setActivityCooldown(ProjectTwEakedConfig.pedestalCooldown.zeroPedCooldown);
			}
			else
			{
	...
	public List<String> getPedestalDescription()
	{
		...
		if (ProjectTwEakedConfig.pedestalCooldown.zeroPedCooldown != -1) {
			list.add(TextFormatting.BLUE + I18n.format("pe.zero.pedestal1"));
			list.add(TextFormatting.BLUE + I18n.format("pe.zero.pedestal2"));
			list.add(TextFormatting.BLUE + I18n.format("pe.zero.pedestal3", MathUtils.tickToSecFormatted(ProjectTwEakedConfig.pedestalCooldown.zeroPedCooldown)));
		}
		return list;
	}
