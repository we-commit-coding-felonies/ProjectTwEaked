...
public class HarvestGoddess extends RingToggle implements IPedestalItem
{
	...
	{
		if (!world.isRemote && ProjectTwEakedConfig.pedestalCooldown.harvestPedCooldown != -1)
		{
			...
			if (tile.getActivityCooldown() == 0)
			{
				...
				tile.setActivityCooldown(ProjectTwEakedConfig.pedestalCooldown.harvestPedCooldown);
			}
			else
			{
	...
	public List<String> getPedestalDescription()
	{
		...
		if (ProjectTwEakedConfig.pedestalCooldown.harvestPedCooldown != -1)
		{
			...
			list.add(TextFormatting.BLUE +
					I18n.format("pe.harvestgod.pedestal3", MathUtils.tickToSecFormatted(ProjectTwEakedConfig.pedestalCooldown.harvestPedCooldown)));
		}
		return list;
	}
