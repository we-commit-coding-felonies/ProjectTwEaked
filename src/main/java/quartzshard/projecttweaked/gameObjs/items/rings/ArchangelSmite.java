...
public class ArchangelSmite extends RingToggle implements IPedestalItem, IModeChanger
{
	...
	{
		if (!world.isRemote && ProjectTwEakedConfig.pedestalCooldown.archangelPedCooldown != -1)
		{
			...
			if (tile.getActivityCooldown() == 0)
			{
				...
				tile.setActivityCooldown(ProjectTwEakedConfig.pedestalCooldown.archangelPedCooldown);
			}
			else
			{
	...
	public List<String> getPedestalDescription()
	{
		...
		if (ProjectTwEakedConfig.pedestalCooldown.archangelPedCooldown != -1) {
			list.add(TextFormatting.BLUE + I18n.format("pe.archangel.pedestal1"));
			list.add(TextFormatting.BLUE + I18n.format("pe.archangel.pedestal2", MathUtils.tickToSecFormatted(ProjectTwEakedConfig.pedestalCooldown.archangelPedCooldown)));
		}
		return list;
	}
}
