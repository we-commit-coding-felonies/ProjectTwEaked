...
{
	private final TweakedTransmutationContainer tablet;
	private final IItemHandlerModifiable items;

	public InventoryCraftingArcaneTablet(TweakedTransmutationContainer container, int width, int height, IItemHandlerModifiable i)
	{
