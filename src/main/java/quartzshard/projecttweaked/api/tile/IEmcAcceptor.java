 ...
 * However, ProjectTwEaked implements an "active-push" system, where providers automatically send EMC to acceptors. You are recommended to follow this convention
...
public interface IEmcAcceptor extends IEmcStorage
{
	 ...
	 * @param toAccept The maximum amount to accept
	 * @return The amount actually accepted
	 * @deprecated Since ProjectTwEaked API version 1.2.0
	 */
	@Deprecated
