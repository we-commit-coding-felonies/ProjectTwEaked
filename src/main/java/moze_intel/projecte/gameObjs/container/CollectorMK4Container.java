...
public class CollectorMK4Container extends CollectorMK1Container
{
	...
	void initSlots(InventoryPlayer invPlayer)
	{
		...
		//Klein Star Slot
		this.addSlotToContainer(new ValidatedSlot(aux, CollectorMK4Tile.UPGRADING_SLOT, 158, 58, SlotPredicates.COLLECTOR_INV));
		...
		//Upgrade Result
		this.addSlotToContainer(new ValidatedSlot(aux, CollectorMK4Tile.UPGRADE_SLOT, 158, 13, SlotPredicates.COLLECTOR_INV));

		//Upgrade Target
		this.addSlotToContainer(new SlotGhost(aux, CollectorMK4Tile.LOCK_SLOT, 187, 36, SlotPredicates.COLLECTOR_LOCK));
	...
	{
		return player.world.getBlockState(tile.getPos()).getBlock() == ObjHandler.collectorMK4
