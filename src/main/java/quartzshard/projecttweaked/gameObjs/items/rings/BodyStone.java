...
public class BodyStone extends RingToggle implements IBauble, IPedestalItem
{
	...
	{
		if (!world.isRemote && ProjectTwEakedConfig.pedestalCooldown.bodyPedCooldown != -1)
		{
			...
			if (tile.getActivityCooldown() == 0)
			{
				...
				tile.setActivityCooldown(ProjectTwEakedConfig.pedestalCooldown.bodyPedCooldown);
			}
			else
			{
	...
	public List<String> getPedestalDescription()
	{
		...
		if (ProjectTwEakedConfig.pedestalCooldown.bodyPedCooldown != -1)
		{
			list.add(TextFormatting.BLUE + I18n.format("pe.body.pedestal1"));
			list.add(TextFormatting.BLUE +
					I18n.format("pe.body.pedestal2", MathUtils.tickToSecFormatted(ProjectTwEakedConfig.pedestalCooldown.bodyPedCooldown)));
		}
		return list;
	}
}
