...
public final class ProjectTwEakedConfig 
{
	...
	{
		@Config.Comment("Instead of vein mining the ore you right click with your Dark/Red Matter Pick/Star it vein mines all ores in an AOE around you like it did in ProjectTwEaked before version 1.4.4.")
	...
	public static class Misc {
		...
		@Config.Comment("Show stats as tooltips for various ProjectTwEaked blocks")
