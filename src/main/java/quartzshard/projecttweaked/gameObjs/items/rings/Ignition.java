...
public class Ignition extends RingToggle implements IBauble, IPedestalItem, IFireProtector, IProjectileShooter
{
	...
	{
		if (!world.isRemote && ProjectTwEakedConfig.pedestalCooldown.ignitePedCooldown != -1)
		{
			...
			if (tile.getActivityCooldown() == 0)
			{
				...
				tile.setActivityCooldown(ProjectTwEakedConfig.pedestalCooldown.ignitePedCooldown);
			}
			else
			{
	...
	public List<String> getPedestalDescription()
	{
		...
		if (ProjectTwEakedConfig.pedestalCooldown.ignitePedCooldown != -1)
		{
			list.add(TextFormatting.BLUE + I18n.format("pe.ignition.pedestal1"));
			list.add(TextFormatting.BLUE +
					I18n.format("pe.ignition.pedestal2", MathUtils.tickToSecFormatted(ProjectTwEakedConfig.pedestalCooldown.ignitePedCooldown)));
		}
		return list;
	}
