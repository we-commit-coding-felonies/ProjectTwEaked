...
public class EvertideAmulet extends ItemPE implements IProjectileShooter, IBauble, IPedestalItem
{
	...
	{
		if (!world.isRemote && ProjectTwEakedConfig.pedestalCooldown.evertidePedCooldown != -1)
		{
			...
			if (tile.getActivityCooldown() == 0)
			{
				...
				tile.setActivityCooldown(ProjectTwEakedConfig.pedestalCooldown.evertidePedCooldown);
			}
			else
			{
	...
	public List<String> getPedestalDescription()
	{
		...
		if (ProjectTwEakedConfig.pedestalCooldown.evertidePedCooldown != -1)
		{
			list.add(TextFormatting.BLUE + I18n.format("pe.evertide.pedestal1"));
			list.add(TextFormatting.BLUE +
					I18n.format("pe.evertide.pedestal2", MathUtils.tickToSecFormatted(ProjectTwEakedConfig.pedestalCooldown.evertidePedCooldown)));
		}
		return list;
	}
