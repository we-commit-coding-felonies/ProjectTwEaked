...
public interface IConversionProxy
{
	 ...
	 *
	 * Adding a Conversion allows ProjectTwEaked to calculate the EMC value for the output based on the specified ingredients.
	 ...
	 * ProjectTwEaked will automatically select the Conversion with the lowest EMC value.
	 *
