package main.java.quartzshard.projecttweaked.emc.mappers.customConversions;

import com.google.common.collect.ImmutableList;
import com.google.common.collect.Maps;
import com.google.gson.Gson;
import com.google.gson.GsonBuilder;
import main.java.quartzshard.projecttweaked.emc.mappers.customConversions.json.CustomConversionDeserializer;
...
import main.java.quartzshard.projecttweaked.emc.mappers.customConversions.json.FixedValues;
import main.java.quartzshard.projecttweaked.emc.mappers.customConversions.json.FixedValuesDeserializer;
...
public class CustomConversionMapper implements IEMCMapper<NormalizedSimpleStack, Long>
{
	...
	{
		return "Uses json files within config/ProjectTwEaked/customConversions/ to add values and conversions";
	}
	...
	public void addMappings(IMappingCollector<NormalizedSimpleStack, Long> mapper, Configuration config)
	{
		...
		if (customConversionFolder.isDirectory() || customConversionFolder.mkdir()) {
			...
			PECore.LOGGER.fatal("COULD NOT CREATE customConversions FOLDER IN config/ProjectTwEaked");
		}
	}
