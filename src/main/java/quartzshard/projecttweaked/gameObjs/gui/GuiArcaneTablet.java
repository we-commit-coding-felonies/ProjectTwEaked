...
import main.java.quartzshard.projecttweaked.client.EnumSearchType;
...
{
	private static final ResourceLocation TEXTURE = new ResourceLocation(PECore.MODID, "textures/gui/arcane_tablet.png");
	...
	{
		String s = EMCFormat.INSTANCE.format(EXUtils.getEMC(mc.player).getEmc());
